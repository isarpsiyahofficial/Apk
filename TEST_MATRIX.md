...
| D13 | Yasak kesin para/aşk/şifa iddiası sıfır | PASS | `religious_content_forbidden_claim_audit_t0334_test.dart`: dua/zikir/dini gün/peygamber/tarih/konu ara/today production data dizinlerini TR/EN/AR yasak claim sözlüğüyle tarar; eksik dataset dizini fail-closed; exact dosya+satır finding; overlap alias dedupe ve bağımsız claim koruması; Flutter CI #3166 + Android Release CI test step exact implementation HEAD `2949529ce3bfd3535c234c50e6cd8befdc046094` üzerinde SUCCESS |
