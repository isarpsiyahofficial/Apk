...
const medievalHistoryT0214Sources = <MedievalHistoryResearchSource>[
  ...
  MedievalHistoryResearchSource(
    ...
    locator: HistorySourceLocator(
      ...
      locator: 'doi:10.1017/CBO9781139027670.025',
    ),
  ),
  MedievalHistoryResearchSource(
...
const medievalHistoryT0214Entries = <MedievalHistoryEntry>[
  ...
  MedievalHistoryEntry(
    ...
    summary: LocalizedHistorySummary(
      tr: 'Büveyhîler 945–1055 arasında Irak ve Batı İran’da Abbâsî sonrası bölgesel devlet sisteminin başlıca güçlerinden biri oldu. Bağdat’ta fiilî siyasi üstünlük kurarken Abbâsî halifeliği dinî ve sembolik bir kurum olarak varlığını sürdürdü.',
      en: 'From 945 to 1055 the Buyids were one of the principal powers of the post-Abbasid regional state system in Iraq and western Iran. They exercised effective political dominance in Baghdad while the Abbasid caliphate continued as a religious and symbolic institution.',
      ar: 'كان البويهيون بين 945 و1055 من أبرز قوى نظام الدول الإقليمية بعد العباسيين في العراق وغرب إيران. ومارسوا نفوذًا سياسيًا فعليًا في بغداد، بينما استمرت الخلافة العباسية مؤسسة دينية ورمزية.',
    ),
    startYearCe: 945,
    endYearCe: 1055,
    certainty: MedievalHistoryCertainty.establishedChronology,
